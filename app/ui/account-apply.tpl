<div class="container well">
    ...
    <p>Det finns inget konto kopplat till #email#. Fyll i följande information för att ansöka om ett.</p>
    <form class="form-horizontal" role="form" action="account/create" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="name" class="form-control" name="name" id="name" value="#name#" placeholder="{Name}">
            </div>
        </div>
        <div class="form-group">
