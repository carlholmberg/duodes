<div class="container well">
    ...
    <div class="col-md-4">
            <h5>{Level}</h5><p id="level" data-type="select" data-value="#level#" data-pk="#id#" data-original-title="{Level}" data-url="user/#id#" class="editable editable-click" data-source="[{value: 1, text: 'Låntagare'}, {value: 2, text: 'Circ'}, {value: 3, text: 'Personal'}, {value: 4, text: 'Administratör'}]" data-value="#level#"></p>
